...
export type BiomeId = "forgotten_catacombs" | "molten_caverns" | "frozen_halls" | "bone_throne";
...
export type ItemSpecialAffixKey = "lifesteal" | "critDamage" | "aoeRadius" | "damageOverTime" | "thorns" | "healthRegen" | "dodgeChance" | "xpBonus" | "soulShardBonus" | "cooldownReduction";
...
export type RunRngStreamName = "procgen" | "spawn" | "combat" | "loot" | "skill" | "boss" | "biome" | "hazard" | "event" | "merchant";
...
export type ReplayInputEvent = ReplayInputMove | ReplayInputAttack | ReplayInputSkill | ReplayInputFloorTransition;
...
export interface MonsterState {
    ...
    aiState: "idle" | "chase" | "kite" | "ambush" | "swarm" | "shield" | "support" | "attack" | "dead";
...
export interface AssetManifestEntry {
    id: string;
    category: "player_sprite" | "monster_sprite" | "boss_sprite" | "tile" | "item_icon" | "skill_icon" | "hud" | "fx" | "ui_icon";
    styleTag: string;
    promptHash: string;
    sourcePath: string;
    outputPath: string;
