...
export class DungeonScene extends Phaser.Scene {
  ...
  private readonly dungeonSceneHostBridge: DungeonSceneHostBridge = (() => {
    ...
    return createDungeonSceneHostBridge({
      ...
      pendingDifficulty: mutableHostField(() => scene.pendingDifficulty, (value) => { scene.pendingDifficulty = value; }),
      selectedDifficulty: mutableHostField(() => scene.selectedDifficulty, (value) => { scene.selectedDifficulty = value; }),
      pendingDailyDate: mutableHostField(() => scene.pendingDailyDate, (value) => { scene.pendingDailyDate = value; }),
      pendingDailyPractice: mutableHostField(() => scene.pendingDailyPractice, (value) => { scene.pendingDailyPractice = value; }),
      pendingRunSeed: mutableHostField(() => scene.pendingRunSeed, (value) => { scene.pendingRunSeed = value; }),
      ...
      aiFrameCounter: mutableHostField(() => scene.aiFrameCounter, (value) => { scene.aiFrameCounter = value; }),
      ...
      nearDeathWindowArmedAtMs: mutableHostField(
        () => scene.nearDeathWindowArmedAtMs,
        (value) => { scene.nearDeathWindowArmedAtMs = value; }
      ),
      nearDeathFeedbackCooldownUntilMs: mutableHostField(
        () => scene.nearDeathFeedbackCooldownUntilMs,
        (value) => { scene.nearDeathFeedbackCooldownUntilMs = value; }
      ),
      ...
      progressionChoiceRuntime: readonlyHostField(() => scene.progressionChoiceRuntime),
      playerActionModule: readonlyHostField(() => scene.playerActionModule),
      encounterController: readonlyHostField(() => scene.encounterController),
      worldEventController: readonlyHostField(() => scene.worldEventController),
      movementSystem: readonlyHostField(() => scene.movementSystem),
      combatRuntime: readonlyHostField(() => scene.combatRuntime),
      combatSystem: readonlyHostField(() => scene.combatSystem),
      aiSystem: readonlyHostField(() => scene.aiSystem),
      eventRuntimeModule: readonlyHostField(() => scene.eventRuntimeModule),
      feedbackRouter: readonlyHostField(() => scene.feedbackRouter),
      sfxSystem: readonlyHostField(() => scene.sfxSystem),
      vfxSystem: readonlyHostField(() => scene.vfxSystem),
      powerSpikeRuntimeModule: readonlyHostField(() => scene.powerSpikeRuntimeModule),
      heartbeatFeedbackRuntime: readonlyHostField(() => scene.heartbeatFeedbackRuntime),
      input: readonlyHostField(() => scene.input),
