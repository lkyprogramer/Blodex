...
const UI_MESSAGES: Record<string, string> = {
  ...
  "boss.branch.molten_trial.title": "Molten Trial Cleared",
  "boss.branch.molten_trial.description": "Claim victory and secure the molten route reward.",
  "boss.branch.molten_trial.description_abyss": "Claim victory and secure the molten route reward.",
  "boss.branch.molten_trial.description_daily": "Claim victory and secure the molten route reward.",
  "boss.branch.molten_trial.log_defeated": "Molten trial cleared. Claim the route reward.",
  "boss.branch.frozen_trial.title": "Frozen Trial Cleared",
  "boss.branch.frozen_trial.description": "Claim victory and secure the frozen route reward.",
  "boss.branch.frozen_trial.description_abyss": "Claim victory and secure the frozen route reward.",
  "boss.branch.frozen_trial.description_daily": "Claim victory and secure the frozen route reward.",
  "boss.branch.frozen_trial.log_defeated": "Frozen trial cleared. Claim the route reward.",
  "boss.challenge.ossuary_trial.title": "Ossuary Trial Complete",
  "boss.challenge.ossuary_trial.description": "Claim the challenge reward and resume the run.",
  "boss.challenge.ossuary_trial.description_abyss": "Claim the challenge reward and resume the run.",
  "boss.challenge.ossuary_trial.description_daily": "Claim the challenge reward and resume the run.",
  "boss.challenge.ossuary_trial.log_defeated": "Challenge boss defeated. Claim your reward and continue.",
